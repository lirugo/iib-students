            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="dialling_code" class="col-md-4 col-form-label text-md-right">{{ __('Dialling code') }}</label>

                            <div class="col-md-6">
                                <select name="dialling_code" class="form-control">
                                    @foreach($diallingCodes as $code)
                                        <option value="{{$code->id}}" {{old('dialling_code') == $code->id ? ' selected="selected"' : ''}}>{{ $code->name }} (+{{$code->dialling_code}})</option>
                                    @endforeach
                                </select>
